...
function buildClaudeAnalysisRequest(input) {
  ...
  return deepFreeze({
    ...
    system: `${CLAUDE_ANALYSIS_SYSTEM_PROMPT} ${sectionThreeTelemetryAllowlistInstruction(canonicalInput)} ${sectionFourReferenceAllowlistInstruction(modelInput.sectionFourReferenceAllowlist)}`,
    messages: [{
      role: 'user',
