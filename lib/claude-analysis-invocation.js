...
function buildClaudeAnalysisRequest(input) {
  ...
  return deepFreeze({
    ...
    system: `${CLAUDE_ANALYSIS_SYSTEM_PROMPT} ${sectionThreeTelemetryAllowlistInstruction(canonicalInput)}`,
    messages: [{
      role: 'user',
