...
const CLAUDE_ANALYSIS_SYSTEM_PROMPT = [
  ...
  'In Section 5, analyze only portfolioContext[analysisRequest.initiatingList]; never substitute securities or references from the other list. If My Stocks initiated the report and is empty, state exactly "No securities are configured in My Stocks." with no references. If Watchlist initiated the report and is empty, state exactly "No securities are configured in Watchlist." with no references.',
