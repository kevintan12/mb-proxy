...
const PLAIN_ENGLISH_REPLACEMENTS = Object.freeze([
  ...
  Object.freeze({pattern: '\\bequity positioning\\b', replacement:
    'how investors are already invested in stocks'}),
  Object.freeze({pattern: '\\b(?:market|investor) positioning\\b', replacement:
    'how investors are already invested'}),
  Object.freeze({pattern: '\\bpositioning\\b', replacement:
    'how investors are already invested'}),
    ...
    for (let index = 0; index < output.sections.length; index++) {
      ...
      if (index === REPORT_SECTION_NAMES.length - 1) {
        ...
        if (!isEmptyInitiatingListStatement) {
          ...
          && input.analysisRequest.selectedScope !== 'US') {
