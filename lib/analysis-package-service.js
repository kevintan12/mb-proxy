...
const ANALYSIS_PACKAGE_REQUEST_KEYS = Object.freeze([
  'selectedScope', 'userTimezone', 'myStocks', 'watchlist'
]);
...
function createAnalysisPackageService({acquireAnalysisMaterial, now = () => new Date()} = {}) {
  ...
  return Object.freeze({
    async assemble(request) {
      ...
      const material = await acquireAnalysisMaterial(acquisitionContext);
