...
function omitFutureUsEvidence(material, generatedAt, onDiagnostics) {
  ...
  // Classification saw the now-omitted item, so none of its causal judgments
  // may be carried into the final, earlier information horizon.
  evidenceContext.materialEvents = [];
  evidenceContext.principalCatalysts = [];
  ...
  evidenceContext.broadMarketFocus = [];
